        ...
        success: function(data) {
            ...
            data.forEach(meliData => {
                var meliPrint = `
                            ...
                            <a class="btn btn-danger deleteConfirm" style="margin-right: 0" data-toggle="tooltip" data-placement="top" title="Eliminar" href="` + url_data_meli + `/index.php?op=mercadolibre&accion=importar&borrar=` + meliData['data']['code'] + `&codProduct=` + meliData['data']['product'] + `">
