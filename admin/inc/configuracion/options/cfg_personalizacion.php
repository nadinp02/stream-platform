...
$page_customization = json_decode(file_get_contents(dirname(__DIR__, 4)  . '/files/customization/page.json'), true);
                                                    ...
                                                    <div class="col-3 " id="<?= $rand ?>">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <div class="input-group-append">
                                                                <button class="btn btn-sm px-1 btn-danger deleteConfirm" onclick="deleteInput('<?= $rand ?>')" type="button"><i class="fa fa-times fs-12" aria-hidden="true"></i></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                <?php } ?>
