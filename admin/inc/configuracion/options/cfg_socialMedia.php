...
$contentRedes = json_decode(file_get_contents(dirname(__DIR__, 4) . '/files/links/links.json', false, stream_context_create($arrContextOptions)), true);
if (isset($_POST["modificar"])) {
    unset($_POST["modificar"]);
    $array = array_combine($_POST['boton'], $_POST['link']);
    unset($array['']);
    file_put_contents(dirname(__DIR__, 4) . '/files/links/links.json', json_encode($array));
