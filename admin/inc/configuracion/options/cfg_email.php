...
<div class="">
    <div class="row">
        <div class="col-md-12">
            <h3 class="pull-left text-uppercase fs-16 bold text-center">Sección de Configuración de Emails</h3>
        </div>
        <div class="col-md-12">
            <hr />
            <span>Si tu plataforma hace algún envío de email, la configuración debe estar completa. Es por eso que necesitamos que solicites a tu Email Manager sobre los siguientes datos.</span>
            <hr />
        </div>
    </div>
