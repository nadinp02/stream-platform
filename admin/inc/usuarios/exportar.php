...
foreach ($usuariosData as $usuario) {
    ...
    $objPHPExcel->getActiveSheet()->SetCellValue("I" . $rowCount, $usuario['data']['calle']);
    $objPHPExcel->getActiveSheet()->SetCellValue("J" . $rowCount, $usuario['data']['numero']);
    $objPHPExcel->getActiveSheet()->SetCellValue("K" . $rowCount, $usuario['data']['piso']);
    $objPHPExcel->getActiveSheet()->SetCellValue("L" . $rowCount, $usuario['data']['localidad']);
    $objPHPExcel->getActiveSheet()->SetCellValue("M" . $rowCount, $usuario['data']['provincia']);
    $objPHPExcel->getActiveSheet()->SetCellValue("N" . $rowCount, $usuario['data']['pais']);
    $objPHPExcel->getActiveSheet()->SetCellValue("O" . $rowCount, $usuario['data']['postal']);
    $objPHPExcel->getActiveSheet()->SetCellValue("P" . $rowCount, $tipo);
    $objPHPExcel->getActiveSheet()->SetCellValue("Q" . $rowCount, $usuario['data']['descuento'] . " %");
