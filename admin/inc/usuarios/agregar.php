...
if (isset($_POST["agregar"])) {
    ...
    $usuarios->set("calle", isset($_POST["calle"]) ? $funciones->antihack_mysqli($_POST["calle"]) : '');
    $usuarios->set("numero", isset($_POST["numero"]) ? $funciones->antihack_mysqli($_POST["numero"]) : '');
    $usuarios->set("piso", isset($_POST["piso"]) ? $funciones->antihack_mysqli($_POST["piso"]) : '');
        ...
        <div class="card-content">
            <div class="card-body">
                <form method="post" class="row">
                    ...
                    <label class="col-md-6">
                        Calle:<br />
                        <input type="text" name="calle" value="<?= isset($_POST["calle"]) ? $_POST["calle"] : '' ?>" required />
                    </label>
                    <label class="col-md-2">
                        Número:<br />
                        <input type="text" name="numero" value="<?= isset($_POST["numero"]) ? $_POST["numero"] : '' ?>" required />
                    </label>
                    <label class="col-md-2">
                       Piso/Dto:<br />
                        <input type="text" name="piso" value="<?= isset($_POST["piso"]) ? $_POST["piso"] : '' ?>"  />
                    </label>
                    <label class="col-md-6">
                        Telefono:<br />
