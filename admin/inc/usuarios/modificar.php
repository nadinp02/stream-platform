        ...
        <div class="card-content">
            <div class="card-body">
                ...
                <form method="post" class="row">
                    ...
                    <label class="col-md-6">
                        Calle:<br />
                        <input type="text" name="calle" value="<?= $usuario['data']['calle']; ?>" required />
                    </label>
                    <label class="col-md-2">
                        Número:<br />
                        <input type="text" name="numero" value="<?= $usuario['data']['numero']; ?>" required />
                    </label>
                    <label class="col-md-2">
                        Piso/Dto:<br />
                        <input type="text" name="piso" value="<?= $usuario['data']['piso']; ?>" />
                    </label>
                    <label class="col-md-6">
                        Telefono:<br />
