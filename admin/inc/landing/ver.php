...
$landingList = $landing->list(["idioma" => $idiomaGet],"","",false);
        ...
        <section class="users-list-wrapper">
            <div class="users-list-table">
                ...
                <?php if ($_SESSION["admin"]["crud"]["crear"]) { ?>
                    <a class="btn btn-success pull-right text-uppercase mt-15 " href="<?= URL_ADMIN ?>/index.php?op=landing&accion=agregar&idioma=<?= $idiomaGet ?>">
                        AGREGAR Landing
                    </a>
                <?php } ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($_SESSION["admin"]["crud"]["editar"]) { ?>
                                                ...
                                                <a style="height: 30px; margin-top:20px; margin-bottom: 20px;" data-toggle="tooltip" data-placement="top" title="Modificar" href="<?= URL_ADMIN . '/index.php?op=landing&accion=modificar&cod=' . $landingItem['data']['cod'] . "&idioma=" . $idiomaGet ?>">
                                            ...
                                            <?php if ($_SESSION["admin"]["crud"]["eliminar"]) { ?>
                                                <a style="height: 30px; margin-top:20px; margin-bottom: 20px;" class="deleteConfirm" data-toggle="tooltip" data-placement="top" title="Eliminar" href="<?= URL_ADMIN ?>/index.php?op=landing&accion=ver&borrar=<?= $landingItem['data']["cod"] ?>&idioma=<?= $idiomaGet ?>">
...
if (isset($_GET["borrar"]) && $_SESSION["admin"]["crud"]["eliminar"]) {
    $landing->delete(["cod" => $borrar, "idioma" => $idiomaGet]);
    $funciones->headerMove(URL_ADMIN . "/index.php?op=landing&idioma=".$idiomaGet);
}
?>