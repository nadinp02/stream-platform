                            ...
                            ?>
                                <div class="row mb-10" id="<?= $countKey ?>">
                                    ...
                                    <div class="col-md-4 mt-30 row">
                                        ...
                                        <a class="btn btn-danger col-md-2 deleteConfirm" style="max-height:37px" type="text" onclick="deleteRow('<?= $countKey ?>')"><i class="fa fa-trash" style="color:white" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                            <?php
                                $countKey++;
...
<script>
    ...
    function agregarCampo() {
      ...
      <div class="row mb-10" id="${contador}">
          ...
          <a class="btn btn-danger col-md-2 deleteConfirm" style="max-height:37px" type="text" onclick="deleteRow('${contador}')"><i class="fa fa-trash" style="color:white" aria-hidden="true"></i></a>
          </div>
      </div>
      `);
        contador++;
