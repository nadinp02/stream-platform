            ...
            <div class="card-body">
                <form method="post" class="row" enctype="multipart/form-data">
                    ...
                    <label class="col-md-7">Imagen:<br />
                        <input type="file" id="file" name="files[]" onchange="filePreview(this)" accept="image/*" required />
...
<script>
    setInterval(checkRequired, 1000);
    $('#idiomasCheckBox').hide();

    function checkRequired() {
        $('#sub').attr('required', $('#chsub').prop('checked') ? true : false);
        $('#link').attr('required', $('#chli').prop('checked') ? true : false);
    }
</script>