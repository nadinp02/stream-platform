                ...
                <div class="card-content">
                    <div class="card-body card-dashboard">
                        ...
                        <?php if ($_SESSION["admin"]["crud"]["crear"]) { ?>
                            <a class="btn btn-success text-uppercase pull-right mt-15" href="<?= URL_ADMIN ?>/index.php?op=estados-pedidos&accion=agregar&idioma=<?= $idiomaGet ?>">
                        ...
                        <div class="table-responsive">
                            <table class="table zero-configuration dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                <thead>
                                    <tr role="row">
                                        <th tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" width="280px">Título</th>
