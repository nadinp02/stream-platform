                            ...
                            <div class="col-md-7">
                                ...
                                <form method="post" class="col-md-12">
                                    <div class="row ">
                                        ...
                                        <div class="col-md-12">
                                            <div class="row mb-10">
                                                <div class="col-md-8 fs-13" ><label>BRINDAR ACCESO A: </label><span onclick="checkColumn('for')"> Todo</span> </div>
                                                <div class="col-md-4">
                                                    <i class="bx bx-plus pull-right mr-30" onclick="checkColumn('create')"></i>
                                                    <i class="bx bx-pencil pull-right mr-23" onclick="checkColumn('edit')"></i>
                                                    <i class="bx bx-trash pull-right mr-27" onclick="checkColumn('delete')"></i>
                                                </div>
                                            </div>
                                            <hr />
...
<script>
    function checkRow(row) {
        var checked = $('#for' + row).is(':checked');
        $("#create-" + row).prop('checked', checked);
        $("#edit-" + row).prop('checked', checked);
        $("#delete-" + row).prop('checked', checked);
    }

    function checkColumn(column) {
        $("input:checkbox[id^=" + column + "]").trigger('click'); 
    }
</script>