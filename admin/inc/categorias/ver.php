                ...
                <?php if ($_SESSION["admin"]["crud"]["eliminar"]) { ?>
                    <div class="dropdown pull-right">
                        <div class="dropdown mb-1">
                            <button type="button" style="padding-top:8px;padding-bottom:8px" class="botoneliminar btn btn-danger    dropdown-toggle ml-10" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                BORRAR POR AREA
                            </button>
                                ...
                                <tr>
                                                        ...
                                                        <?php foreach ($val['subcategories'] as $sub) { ?>
                                                            ...
                                                            <div class="btn-group pull-right" role="group" aria-label="Basic example">
                                                                ...
                                                                <?php if ($_SESSION["admin"]["crud"]["eliminar"]) { ?>
                                                                    ...
                                                                    <a href='<?= URL_ADMIN ?>/index.php?op=categorias&accion=ver&borrarSubcategorias=<?= $sub['data']["cod"] ?>&idioma=<?= $sub['data']["idioma"] ?>' data-toggle="tooltip" data-placement="top" title="Eliminar" class="btn btn-danger deleteConfirm">
                                                                        <div class="fonticon-wrap">
                                                                        ...
                                                                        <?php foreach ($sub['tercercategories'] as $ter) { ?>
                                                                            ...
                                                                            <div class="btn-group pull-right" role="group" aria-label="Basic example">
                                                                                ...
                                                                                <?php if ($_SESSION["admin"]["crud"]["editar"]) { ?>
                                                                                    ...
                                                                                    <a href='<?= URL_ADMIN ?>/index.php?op=categorias&accion=ver&borrarTercercategorias=<?= $ter['data']["cod"] ?>&idioma=<?= $ter['data']["idioma"] ?>' data-toggle="tooltip" data-placement="top" title="Eliminar" class="btn btn-danger deleteConfirm">
                                                                                        <div class="fonticon-wrap">
                                                                                            <i class="bx bx-trash fs-16"></i>
                                                                                        </div>
                                                                                    </a>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <?php } ?>
                                            <?php if ($_SESSION["admin"]["crud"]["eliminar"]) { ?>
                                                <a data-toggle="tooltip" class="deleteConfirm btn btn-danger" data-placement="top" title="Eliminar" href="<?= URL_ADMIN ?>/index.php?op=categorias&accion=ver&borrar=<?= $val['data']["cod"] ?>&idioma=<?= $idiomaGet ?>">
                                                    <div class="fonticon-wrap">
...
if (isset($_GET["borrarTercercategorias"]) && $_SESSION["admin"]["crud"]["eliminar"]) {
    ...
    $tercercategorias->delete(["cod" => $cod, "idioma" => $idiomaGet]);
