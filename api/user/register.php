...
if ($responseData->success) {
    if ($password1 == $password2) {
        ...
        $calle = isset($_POST["calle"]) ? $funciones->antihack_mysqli($_POST["calle"]) : '';
        $numero = isset($_POST["numero"]) ? $funciones->antihack_mysqli($_POST["numero"]) : '';
        $piso = isset($_POST["piso"]) ? $funciones->antihack_mysqli($_POST["piso"]) : '';
        ...
        $postal = isset($_POST["postal"]) ? $funciones->antihack_mysqli($_POST["postal"]) : '';
        ...
        if (!empty($nombre) && !empty($apellido) && !empty($email) && !empty($calle) && !empty($numero) && !empty($telefono) && !empty($celular)) {
            ...
            $usuario->set("calle", $calle);
            $usuario->set("numero", $numero);
            $usuario->set("piso", $piso);
            ...
            if ($response['status']) {
                ...
                if ($usuario->add()) {
                    ...
                    $hubspot->set("direccion", $calle . ' ' . $numero . ' ' . $piso);
