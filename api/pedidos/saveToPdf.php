                    ...
                    <div class="form-register-title" id="print" style="width:100%;display:block; ">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div style="padding-top:20px"><b><?= $_SESSION["lang-txt"]["checkout"]["detail"]["metodo_pago"] ?>:</b> <?= mb_strtoupper($pedido_info['data']["pago_titulo"]); ?> </div>
                                <?php if (!empty($pedido_info['data']['leyenda_pago'])) {
                                ...
                                <div class="row mb-15" style="margin-top:30px">
                                    <?php if (!empty($pedido_info['detalle_envio'])) { ?>
                                        <div class="col-md-6" style="width:48%;float:left">
                                            ...
                                            <br>
                                            <?= $pedido->getInfoPedido($pedido_info['detalle_envio']); ?>
                                    ...
                                    <?php if (!empty($pedido_info['detalle_pago'])) { ?>
                                        <div class="col-md-6" style="width:51%;float:right;">
                                            ...
                                            <br>
                                            <?= $pedido->getInfoPedido($pedido_info['detalle_pago']); ?>
                                            <?php
...
file_put_contents(dirname(__DIR__, 2) . "/files/export/pedidos/" . $cod . ".html", ob_get_contents());
$dataHTML = file_get_contents(dirname(__DIR__, 2)  . "/files/export/pedidos/" . $cod . ".html", false, stream_context_create($arrContextOptions));

$dompdf->loadHtml($dataHTML);
$dompdf->setPaper('A4', 'portrait');
$dompdf->render();
$data = $dompdf->output();
file_put_contents(dirname(__DIR__, 2) . "/files/export/pedidos/" . $cod . ".pdf", $data);
$f->headerMove(URL . "/files/export/pedidos/" . $cod . ".pdf");
