        ...
        <div class="row">
            <div class="col-md-12">
                            ...
                            <div class="single-product-head">
                                <div class="product-details">
                                    ...
                                    <form class="add-quantity" id="cart-f" data-url="<?= URL ?>" onsubmit="addToCart('cart-f','','<?= URL ?>', '')">
                                        ...
                                        <?php if (isset($_SESSION["perfil-ecommerce"]["data"]) && $_SESSION["perfil-ecommerce"]["data"]["saltar_checkout"] != 'all') { ?>
                ...
                <?php if (!empty($productoData['data']['desarrollo'])) { ?>
                    <h3 class="text-uppercase"><?= $_SESSION["lang-txt"]["productos"]["descripcion"] ?></h3>
                    <hr />
                    <p><?= $productoData['data']['desarrollo'] ?></p>
                <?php } ?>

                <?php if ($producto_relacionados_) { ?>
