...
<div class="col-md-12 mb-10">
    ...
    if (isset($_POST["guardar"])) :
        ...
        $doc = !empty($_POST["doc"]) ? $f->antihack_mysqli($_POST["doc"]) : '';
        ...
        $calle = !empty($_POST["calle"]) ? $f->antihack_mysqli($_POST["calle"]) : '';
        $numero = !empty($_POST["numero"]) ? $f->antihack_mysqli($_POST["numero"]) : '';
        $piso = !empty($_POST["piso"]) ? $f->antihack_mysqli($_POST["piso"]) : '';
        ...
        if (empty($error)) {
            ...
            $usuario->editSingle("doc", $doc);
            $usuario->editSingle("calle", $calle);
            $usuario->editSingle("numero", $numero);
            $usuario->editSingle("piso", $piso);
    ...
    <form class="login_form" id="registro" method="post" autocomplete="off">
        ...
        <br />
        <div class="row">
            <div class="col-md-8"><?= $_SESSION["lang-txt"]["usuarios"]["email"] ?>
                <div class="input-group">
            ...
            <div class="col-md-4"><?= $_SESSION["lang-txt"]["usuarios"]["cuit"] ?>
                <div class="input-group">
                    <input class="form-control h40" value="<?= $usuarioData['data']['doc'] ?>" type="number" placeholder="<?= $_SESSION["lang-txt"]["usuarios"]["cuit"] ?>" name="doc" required />
        ...
        <br />
        <div class="row">
            <div class="col-md-4"><?= $_SESSION["lang-txt"]["usuarios"]["provincia"] ?>
                <div class="input-group">
            ...
            <div class="col-md-4"><?= $_SESSION["lang-txt"]["usuarios"]["localidad"] ?>
                <div class="input-group">
            ...
            <div class="col-md-4"><?= $_SESSION["lang-txt"]["usuarios"]["codigo_postal"] ?>
                <div class="input-group">
        ...
        <br />
        <div class="row">
            <div class="col-md-4"><?= $_SESSION["lang-txt"]["usuarios"]["calle"] ?>
                <div class="input-group">
                    <input class="form-control h40" value="<?= $usuarioData['data']['calle'] ?>" type="text" placeholder="<?= $_SESSION["lang-txt"]["usuarios"]["calle"] ?>" name="calle" required />
                    <span class="input-group-addon"><i class="login_icon glyphicon glyphicon-map-marker"></i></span>
                </div>
            </div>
            <div class="col-md-4"><?= $_SESSION["lang-txt"]["usuarios"]["numero"] ?>
                <div class="input-group">
                    <input class="form-control h40" value="<?= $usuarioData['data']['numero'] ?>" type="number" placeholder="<?= $_SESSION["lang-txt"]["usuarios"]["numero"] ?>" name="numero" required />
                    <span class="input-group-addon"><i class="login_icon glyphicon glyphicon-map-marker"></i></span>
                </div>
            </div>
            <div class="col-md-4"><?= $_SESSION["lang-txt"]["usuarios"]["piso"] ?>
                <div class="input-group">
                    <input class="form-control h40" value="<?= $usuarioData['data']['piso'] ?>" type="text" placeholder="<?= $_SESSION["lang-txt"]["usuarios"]["piso"] ?>" name="piso" />
                    <span class="input-group-addon"><i class="login_icon glyphicon glyphicon-map-marker"></i></span>
                </div>
            </div>
        </div>
