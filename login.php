...
$link = (!empty($_SESSION['usuarios'])) ? $checkout->checkSkip() : '';
                            ...
                            <form id="register" data-url="<?= URL ?>" data-link="<?= CANONICAL ?>" data-type="stages" data-captcha="<?= $captchaData["data"]["captcha_key"]  ?>" onsubmit="registerUser()">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select id='localidad' class="form-control mb-3" name="localidad" required>
                                            <option value="" selected><?= $_SESSION["lang-txt"]["usuarios"]["localidad"] ?></option>
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-fild mb-12">
                                            <span><label><?= $_SESSION["lang-txt"]["usuarios"]["postal"] ?> <span class="required">*</span></label></span>
                                            <input class="form-control" name="postal" value="" type="text" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-fild mb-12">
                                            <span><label><?= $_SESSION["lang-txt"]["usuarios"]["calle"] ?> <span class="required">*</span></label></span>
                                            <input class="form-control" name="calle" value="" type="text" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-fild mb-12">
                                            <span><label><?= $_SESSION["lang-txt"]["usuarios"]["numero"] ?> <span class="required">*</span></label></span>
                                            <input class="form-control" name="numero" value="" type="number" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-fild mb-12">
                                            <span><label><?= $_SESSION["lang-txt"]["usuarios"]["piso"] ?> </label></span>
