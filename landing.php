...
#List de landing (al ser único el título, solo trae un resultado)
$landing->set("cod",$cod);
$landing->set("idioma",$_SESSION['lang']);
$landingData = $landing->list(["cod" => $cod, "idioma" => $_SESSION['lang']],'','',true);
